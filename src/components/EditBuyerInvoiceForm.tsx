...
export async function action({ request }: any) {
  ...
  const transactionPrice = requestData.get("tran_price");
  ...
  // edit
  const editCode = requestData.get("edit");
  ...
  try {
    await VehicleTransactionService.edit(values, editCode);
...
export default EditBuyerInvoiceForm;
